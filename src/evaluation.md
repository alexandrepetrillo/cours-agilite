...
- **Évaluer chaque critère** de 0 à 3 :
  - **0** = Non observé / Non acquis
  - **1** = En cours d'acquisition (participe peu, compréhension partielle)
  - **2** = Acquis (participe activement, bonne compréhension)
  - **3** = Maîtrisé (excellente compréhension, aide les autres, propose des améliorations)

- L'évaluation se fait **pendant les activités**, pas sur un examen final.

---

## C29 — Planifier et conduire le projet en appliquant des méthodologies Agile
...
## C31 — Suivi continu des indicateurs de performance
...
## C32 — Évaluations périodiques de l'avancement
...
| Compétence | Note | Barème |
|-----------|------|--------|
| C29 — Méthodologies Agile | | /18 |
| C30 — Coordination d'équipe | | /15 |
| C31 — Indicateurs de performance | | /12 |
| C32 — Évaluations périodiques | | /15 |
| **TOTAL** | | **/60** |
...
| Note globale | Niveau | Appréciation |
|-------------|--------|-------------|
| 48-60 | 🟢 Maîtrisé | Excellente compréhension et mise en pratique |
| 36-47 | 🟡 Acquis | Bonne compréhension, quelques points à approfondir |
| 24-35 | 🟠 En cours | Compréhension partielle, accompagnement nécessaire |
| 0-23 | 🔴 Non acquis | Compréhension insuffisante, remédiation requise |
