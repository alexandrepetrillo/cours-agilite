...
| Code | Compétence |
|------|-----------|
| **C29** | Planifier et conduire le projet en appliquant des méthodologies de gestion de projet (V, cascade, Agile) |
| **C30** | Coordonner les équipes de projet avec des outils collaboratifs |
| **C31** | Suivi continu des indicateurs de performance et gestion budgétaire |
| **C32** | Évaluations périodiques de l'avancement par revues de performance |

---

## 📚 Chapitres couverts

1. Principes de la méthodologie Agile
2. Scrum, un framework Agile incontournable
3. Kanban, une approche visuelle de la gestion de projet
4. Extreme Programming (XP)
5. Mise en œuvre de la méthodologie Agile dans un projet
...
- Comprendre et expliquer les valeurs et principes du Manifeste Agile
...
|---|---|
| **Type** | 🎮 Jeu sérieux |
| **Objectif** | Comprendre la vélocité, l'estimation et l'amélioration continue |
| **Compétences** | C31, C32 |
| **Matériel** | 20+ balles en mousse (ou balles de tennis), chronomètre, tableau de score |
...
| Itération | Phase | Durée |
|-----------|-------|-------|
| **Sprint 1** | Estimation → Exécution (2 min) → Comptage | 5 min |
| **Retro 1** | Comment s'améliorer ? | 2 min |
| **Sprint 2** | Estimation → Exécution (2 min) → Comptage | 5 min |
| **Retro 2** | Encore mieux ! | 2 min |
| **Sprint 3** | Estimation → Exécution (2 min) → Comptage | 5 min |
| **Sprint 4** | Estimation → Exécution (2 min) → Comptage | 5 min |
| **Sprint 5** | Dernier sprint ! | 5 min |

**Débrief** (10 min) :
- Tracer la **courbe de vélocité** au tableau (points par sprint)
- Expliquer les concepts : **vélocité**, **estimation**, **burn-up chart**
- « Comment cette courbe ressemble à un vrai projet ? »
- Lien avec C31 : indicateurs de performance
...
1. **La métaphore du restaurant** (10 min) :
   ...
   - Le temps entre la commande et le service = le **Lead Time**
   - Si trop de commandes en parallèle → chaos, erreurs, retards

2. **Simulation physique** (20 min) :
   - Installer un tableau Kanban « Restaurant » au mur
   - Distribution de cartes « commandes » (burgers, pizzas, salades avec différentes complexités)
   - **Round 1** : pas de limite WIP → observer le chaos
...
| | |
|---|---|
| **Type** | 📚 Cours interactif + Démo live |
| **Objectif** | Découvrir les pratiques clés de l'XP |
| **Compétences** | C29 |
| **Matériel** | Slides, IDE projeté (VS Code), projet de démo préparé |

**Déroulé :**
1. **Les 5 valeurs de l'XP** (5 min) : Communication, Simplicité, Feedback, Courage, Respect

2. **Les pratiques clés** (15 min) :
   - 👥 **Pair Programming** : un pilote, un navigateur — démo avec un volontaire
   - 🧪 **TDD (Test-Driven Development)** : Red → Green → Refactor
   - 🔄 **Intégration Continue** : commit souvent, testez toujours
   - 🧹 **Refactoring** : améliorer le code sans changer le comportement
   - 📋 **Planning Game** : estimation collective

3. **Live Coding TDD** (20 min) :
   - Kata **FizzBuzz** en TDD devant les étudiants
   - Le formateur code en expliquant chaque étape Red → Green → Refactor
   - Les étudiants peuvent suggérer les tests à écrire
   - Langage : Python ou JavaScript (selon le groupe)
...
|---|---|
| **Type** | 🔧 Atelier pratique |
| **Objectif** | Pratiquer le Pair Programming et le TDD |
| **Compétences** | C29, C30 |
| **Matériel** | PCs (1 pour 2), IDE installé, framework de test (pytest/Jest/JUnit) |
...
## 📊 Tableau récapitulatif — Couverture des compétences
...
## 📊 Tableau récapitulatif — Couverture des exercices du référentiel
...
- Peliks, G. (2015). *La méthode Agile dans la gestion de projet : Les fondamentaux*. Dunod.
- Aubry, C. (2018). *Scrum : le guide pratique de la méthode Agile la plus populaire*. D-BookeR Éditions.
