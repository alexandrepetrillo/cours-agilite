...
public class SpaghettiTest {
    ...
    void simpleCart() {
        ...
        List<String[]> items = List.of(new String[]{"Item", "10.0", "1"});
    ...
    void vipDiscount() {
        ...
        List<String[]> items = List.of(new String[]{"Item", "100.0", "1"});
    ...
    void quantityDiscount() {
        ...
        List<String[]> items = List.of(new String[]{"Item", "10.0", "5"});
    ...
    void freeShippingFr() {
        ...
        List<String[]> items = List.of(new String[]{"Item", "200.0", "1"});
